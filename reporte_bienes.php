            ...
            <tbody>
                <?php if($total_bienes > 0): ?>
                    <?php foreach($registros as $r): 
                        $estadoClass = 'bg-malo';
                        if ($r['estado'] == 'Nuevo') $estadoClass = 'bg-nuevo';
                        if ($r['estado'] == 'Bueno') $estadoClass = 'bg-bueno';
                        if ($r['estado'] == 'Regular') $estadoClass = 'bg-regular';
                        if ($r['estado'] == 'Reparar') $estadoClass = 'bg-reparar';
                    ?>
