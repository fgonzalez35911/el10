<?php
// reporte_mermas.php - REPORTE PDF CORPORATIVO
session_start();
...
<head>
    ...
    background: white;
    width: 210mm;
    height: 296mm; /* Casi el total del A4 */
    margin: 0 auto !important; /* Quitamos los 20px de arriba */
    padding: 15mm;
...
<body>
    ...
    <div id="reporteContenido" class="page">
        ...
        <h3 style="color: #dc3545; border-left: 5px solid #dc3545; padding-left: 10px; margin-bottom: 20px;">DETALLE DE MERMAS Y BAJAS DE STOCK</h3>

        <table>
            <thead><tr><th>FECHA</th><th>OPERADOR</th><th>PRODUCTO</th><th>MOTIVO</th><th>CANT.</th><th style="text-align: right;">PÉRDIDA (Costo)</th></tr></thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo strtoupper($r['descripcion']); ?></td>
                ...
                <?php endforeach; ?>
                <?php if(empty($registros)): ?><tr><td colspan="6" style="text-align:center;">No hubo mermas registradas en este período.</td></tr><?php endif; ?>
                
                <tr class="total-row">
                    <td colspan="5" style="text-align: right;">TOTAL PÉRDIDA VALORIZADA:</td>
                    <td style="text-align: right; color: #dc3545;">-$<?php echo number_format($totalPerdida, 2, ',', '.'); ?></td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="footer-section">
            <div style="width: 55%; font-size: 8pt; color: #666; line-height: 1.4;">
                <p><strong>DECLARACIÓN:</strong> Documento generado por el sistema de gestión. Refleja las pérdidas de inventario por roturas, vencimientos u otros motivos registrados.</p>
            </div>
    ...
    // Aseguramos que no haya scroll que desplace la captura
    window.scrollTo(0, 0);
    ...
    const opt = { 
        ...
        // Eliminamos pagebreak para que html2pdf solo tome el contenedor como UNA sola pieza
    };
